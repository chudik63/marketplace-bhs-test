...
type UserRepository interface {
	...
	UpdateBalance(ctx context.Context, userID uint64, newBalance float64) error
}
...
func (r *userRepository) UpdateBalance(ctx context.Context, userID uint64, newBalance float64) error {
